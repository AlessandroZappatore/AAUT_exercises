# AAUT Laboratory Exercises

This repository contains my solutions to the exercises and laboratory sessions for the **Apprendimento Automatico (AAUT)** course.

## 📂 Exercises List

Below is the list of available notebooks with their current status.

### Meo

| Nr. | Topic / Exercise Name | File Link | Status |
|:---:|:---|:---|:---:|
| 1. | Iris Classification (Decision Tree) | [classification_iris_DT_aa_2025_26.ipynb](./classification_iris_DT_aa_2025_26.ipynb) | ❌ |
| 2. | Iris Classification (ANN) | [Classification_Iris_ANN_aa_25_26.ipynb](./Classification_Iris_ANN_aa_25_26.ipynb) | ❌ |
| 3. | Naive Bayes su Watermelon dataset | [Classification_watermelon_NB_aa_2025_26.ipynb](./classification_watermelon_NB_aa_2025_26.ipynb) | ❌ |
